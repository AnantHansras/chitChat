...
const {allMessages,sendMessage,deleteMessage,reactToMessage,allBotMessages,sendBotMessage,sendMessageToBot} = require('../controllers/message');
...
router.post('/chatbot', jwtCheck, sendMessageToBot);
